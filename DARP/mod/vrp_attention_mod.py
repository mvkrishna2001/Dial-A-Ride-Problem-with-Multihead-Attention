...
from mod.layers import MultiHeadAttention
...
class GraphAttentionEncoder(tf.keras.layers.Layer):
    ...
    def __init__(self, input_dim, num_layers=2, num_heads=8, feed_forward_hidden=512):
        super().__init__()
    ...
    def __call__(self, x, mask=None, cur_num_nodes=None):
