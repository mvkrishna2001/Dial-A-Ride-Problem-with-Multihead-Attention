...
from mod.vrp_attention_mod import GraphAttentionEncoder
...
class RLAgent(object):
    ...
    def __init__(self,
        ...
        self.embedding, self.embedder = LinearEmbedding(args['embedding_dim'], _scope=_scope+'Actor/'), GraphAttentionEncoder(input_dim=self.args['embedding_dim'])
    ...
    def load_model(self):
        ...
        else: print('Haha, its a flop Bois')
